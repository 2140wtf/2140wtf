...
- Account switching closes the identity pool and every isolated Concord
  session. Generation-bound capabilities prevent stale async work from
  reopening a revoked account or community session.
