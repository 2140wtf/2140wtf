...
### Changed
- Bleep is now the common 2140-pets hatch — the species roll inside the 2140 Pets category was uniform (1-in-5), so the newest animated character almost never appeared. Category members now carry a pick weight and Bleep rolls at 80%, with the four SVG forms (Glitch Fox, Bio-Mech Moth, Liquid Blob, Honey Badger) sharing the remaining 20%
