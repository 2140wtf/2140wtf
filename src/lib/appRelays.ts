 ...
 *
 * NOTE: BAO's relay (wss://relay.bao.network) is deliberately NOT an app
 * default — the app runs on public relays. ₿AO features that need BAO
 * infrastructure (markets, court, treasury Nutzap info) connect to it
