...
export const EXTRA_KINDS: ExtraKindDef[] = [
  ...
  },
  {
    ...
    label: 'Mini apps',
    description: 'Sandboxed HTML5 mini-apps shared over Nostr',
    route: 'mini-apps',
    addressable: false,
    section: 'social',
    blurb: 'Mini-apps are sandboxed HTML5 archives (.xdc files) shared over Nostr. Play games, run tools, and collaborate with others.',
  ...
  },
  {
    ...
    id: 'roadstr',
    showKey: 'showRoadstr',
    feedKey: 'feedIncludeRoadstr',
    label: 'Roadstr',
    description: 'Decentralized road event reports (kind 1315)',
    route: 'roadstr',
    addressable: false,
    section: 'social',
    blurb: 'Road event reports from drivers around you — police, accidents, hazards, traffic jams, and more. Published on Nostr and displayed on an interactive map.',
    sites: [{ url: 'https://github.com/jooray/roadstr', name: 'Roadstr' }],
  },
  {
    kind: 36767,
    id: 'themes',
  ...
  },
  {
    ...
    // Include NIP-69 zap polls (kind 6969) under the same Polls feed and toggle.
    extraFeedKinds: [6969],
    label: 'Polls',
