...
/**
 * Collection of placeholder lyrics for singing to a 2140.wtf Pet.
 * Simple, fun, and appropriate for all ages.
 */
export const PETS_LYRICS: LyricsEntry[] = [
  {
    id: 'lullaby-1',
    title: '2140.wtf Pet Lullaby',
    lines: [
      'Little 2140.wtf Pet, close your eyes,',
  ...
  {
    id: 'happy-song-1',
    title: 'Happy 2140.wtf Pet Song',
    lines: [
      '2140.wtf Pet, 2140.wtf Pet, jump around!',
