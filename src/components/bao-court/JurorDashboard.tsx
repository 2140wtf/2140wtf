      ...
      <TabsList className="grid w-full grid-cols-3">
        {settings.demoMode ? (
          <TabsTrigger value="lobby" className="gap-2">
            ...
            <span className="hidden sm:inline">Practice Lobby</span>
        ...
        <TabsTrigger value="sessions" className="gap-2">
          ...
          <span className="hidden sm:inline">My Jury Duty</span>
            ...
            <Card className="border-dashed">
              <CardContent className="py-12 px-8 text-center">
                <p className="text-muted-foreground max-w-sm mx-auto">
                  No disputes need a jury right now. Check back later, or join the jury roll from
                  Settings so you're ready when one is filed.
                </p>
              </CardContent>
            </Card>
          ) : (
        ...
        {activeSession ? (
          <Card>
            <CardContent className="p-4 space-y-3">
              ...
              <Button onClick={() => setSessionOpen(true)}>Return to your jury</Button>
            </CardContent>
          </Card>
        ) : (
          <Card className="border-dashed">
            <CardContent className="py-12 px-8 text-center">
              <p className="text-muted-foreground max-w-sm mx-auto">
                You're not on a jury right now. {settings.demoMode
                  ? 'Join a room from the Practice Lobby tab to try it out.'
                  : 'Pick a dispute from the Open Disputes tab to start voting.'}
              </p>
            </CardContent>
          </Card>
        )}
