...
export const BAO_COMMANDS: BaoCommand[] = [
  ...
  {
    verb: "identities",
    summary: "List saved identities and the active one.",
    usage: "identities",
    description: "Lists every identity saved in this store (browser localStorage or CLI state dir) with its role, community, and npub.",
    category: "identity",
    scope: "global",
    access: "anyone",
  },
  {
    verb: "use",
    summary: "Switch the active identity.",
    usage: "use <name>",
    description: "Set which saved identity subsequent commands act on (mirrors the CLI's --as).",
    category: "identity",
    scope: "global",
    access: "anyone",
  },
  {
    verb: "remove",
    summary: "Delete a saved identity.",
    usage: "remove [--as <name>]",
    description: "Removes an identity from the store. Local only — nothing on the relays is deleted.",
    category: "identity",
    scope: "global",
    access: "anyone",
  },
