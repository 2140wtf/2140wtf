        ...
        <Accordion type="multiple" className="rounded-xl border px-4">
          ...
          <AccordionItem value="where" className="border-b-0">
            ...
            <AccordionContent className="space-y-3 text-muted-foreground">
              ...
              <Button asChild variant="outline" size="sm"><Link to="/community"><MessageCircle className="mr-2 size-4" />Open 2140 Trollbox</Link></Button>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
        ...
        <CardContent id={contentId} className="pt-0 space-y-4">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            <Button asChild variant="outline" className="justify-start">
              <Link to="/community" className="inline-flex items-center"><MessageCircle className="mr-2 size-4" /> Discuss work in a ₿AO</Link>
            </Button>
          </div>
