/**
 * FalLivePage — fal.live studio, iframed through the bao-fal-proxy
 * Cloudflare Worker (the origin sends X-Frame-Options: DENY; the proxy
 * strips it), with a live trollbox chat docked on the right.
 *
...
import { FAL_LIVE_URL, FAL_PROXY_URL } from "@/lib/falLive";
  ...
  return (
    <aside className="flex w-80 shrink-0 flex-col border-l bg-muted/30">
      <div className="flex items-center gap-2 border-b px-3 py-2">
        ...
        <span className="text-sm font-semibold flex-1">Trollbox</span>
        <span
          className={
