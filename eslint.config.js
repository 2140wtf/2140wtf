...
export default tseslint.config(
  { ignores: ["dist", "android", "ios", ".agents", ".tools", ".research", ".tmp", "vendor", ".claude", "src/lib/baosocial/**/*.d.ts", "services/escrow-operator/dist", "services/escrow-operator/node_modules"] },
  {
